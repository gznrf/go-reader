...
var file_auth_proto_depIdxs = []int32{
	0, // 0: auth_proto.Auth.Register:input_type -> auth_proto.RegisterRequest
	2, // 1: auth_proto.Auth.Login:input_type -> auth_proto.LoginRequest
	1, // 2: auth_proto.Auth.Register:output_type -> auth_proto.RegisterResponse
	3, // 3: auth_proto.Auth.Login:output_type -> auth_proto.LoginResponse
